...
class DestinationOriginal extends Component {
  render() {
    return (
      <View style={styles.root}>
        <LinearGradient
          ...
          <View style={styles.header}>
            ...
            <View>
              <Text style={styles.textheader}>Kota Tujuan</Text>
            </View>
          </View>
        </LinearGradient>
        <LinearGradient
            ...
            <View style={styles.wrapmenucomp}>
              <View style={styles.wrapicon}>
                ...
                <View style={styles.wraplocation}>
                  <Text style={styles.textlocation}>Bali</Text>
                </View>
              </View>
            </View>
          </View>
...
const Destination = withNavigation(DestinationOriginal);
