...
class OrderflightOriginal extends Component {
  render() {
    let data = [
      {
        value: 'Mr',
          ...
          <View style={styles.wrapcontent1}>
            <View style={styles.wrapitems}>
              <View style={styles.wraprighitem}>
                <Text>LION AIR</Text>
                <Text>Jakarta - Yogyakarta</Text>
                <Text>Minggu, 26 Jan 2020, 0450 CGK - 06:00 JOG</Text>
              </View>
            </View>
            <View style={styles.wrapinfo}>
              <View style={styles.wrapinfo1}>
                <Text style={styles.nama}>Lion Air (Dewasa (x1))</Text>
                <Text style={styles.harga}> Rp 822.096</Text>
              </View>
            </View>
            <View style={styles.wrapdata}>
              <Text style={styles.textheader11}>DATA PENUMPANG</Text>
            </View>
            <TouchableOpacity
              onPress={() => this.props.navigation.navigate('Guestdata')}>
              <View style={styles.wrapdatatamu}>
                <Text>Isi data dewasa</Text>
              </View>
            </TouchableOpacity>
            <TouchableOpacity>
...
const Orderflight = withNavigation(OrderflightOriginal);
